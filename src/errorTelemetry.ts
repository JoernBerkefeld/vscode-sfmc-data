 ...
 * @returns {string | undefined} the name, or undefined when it is not a safe identifier
 */
 ...
 * @returns {string | undefined} the sanitized code, or undefined
 */
 ...
 * @returns {FailureTelemetryProperties} properties safe to send on a `failed` event
 */
